<?php
    ...
    use Lang;
    use Cb\SSButtons\Classes\ButtonsParameters as Buttons;
    ...
    trait Shared {
        ...
        public static function getPropertyJS() {
            return [
                'title'             => Lang::get('cb.ssbuttons::lang.shared.js_title'),
                'description'       => Lang::get('cb.ssbuttons::lang.shared.js_descr'),
                'type'              => 'checkbox',
                'default'           => false,
                'showExternalParam' => false
            ];
        ...
        public static function getPropertyButtons($button) {
            return [
                'title'             => Lang::get('cb.ssbuttons::lang.settings.'.$button),
                'description'       => 'Display ' . Lang::get('Cb.ssbuttons::lang.settings.'.$button) . ' button',
                'default'           => true,
                'type'              => 'checkbox',
                'showExternalParam' => false,
                'group'             => Lang::get('cb.ssbuttons::lang.shared.buttons_group')
            ];
        }

        public static function getPropertyCustomOrder() {
            return [
                'title'             => Lang::get('cb.ssbuttons::lang.shared.order_custom'),
                'description'       => Lang::get('cb.ssbuttons::lang.shared.order_customd'),
                'default'           => false,
                'type'              => 'checkbox',
                'showExternalParam' => false,
                'group'             => Lang::get('cb.ssbuttons::lang.shared.order_group'),
            ];
        }
        ...
        public static function getPropertyOrder($button, $position, $max) {
            return [
                'title'             => Lang::get('cb.ssbuttons::lang.settings.'.$button),
                'description'       => Lang::get('cb.ssbuttons::lang.shared.order_descr'),
                'default'           => $position,
                'type'              => 'string',
                'showExternalParam' => false,
                'group'             => Lang::get('cb.ssbuttons::lang.shared.order_group'),
                'validation'        => [
                    'integer' => [
                        'message' => Lang::get('cb.ssbuttons::lang.shared.order_valid'),
                        'min'     => ['value' => 1],
                        'max'     => ['value' => $max]
                    ]
                ]
