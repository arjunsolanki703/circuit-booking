let darSky_main = document.querySelector('.darSky_main');

darSky_main.querySelector('.darSky_main .more').addEventListener('click', function () {
    document.querySelector('.darSky_more_shadow').classList.toggle('darSky_more_hidden');
});

document.querySelector('.darSky_more_shadow').addEventListener('click', function (e) {
    document.querySelector('.darSky_more_shadow').classList.toggle('darSky_more_hidden');
});
...
function ddg_spice_forecast(r) {
    ...
    var set_skycons = function (elem_id, type) {
        ...
        icon.setAttribute('id', 'fe_day_icon' + type)
        icon.setAttribute('class', 'fe_icon');

        if (elem_id==='fe_current_icon'){
    ...
    var build_currently = function (f) {
        ...
        // temp_str += '<span class="fe_temp_unit">'+unit_labels[units].temperature+'</span>'
